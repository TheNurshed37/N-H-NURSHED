...
$(document).ready(function() {
    "use strict";
    if ($('.sidebar-portfolio').length) {
        if ($(window).width() >= 768) {
            $(".sidebar-portfolio").niceScroll({
                cursorwidth: 5,
                cursorcolor: '#000000',
            });
            $(".horizontal-content").niceScroll({
                cursorwidth: 10,
                cursorcolor: '#000000',
                autohidemode: false
            });
    ...
    var $html = $('html'),
        $main = $('#main'),
        $story_image = $('.stories_single_page_items .featured-image'),
        $header = $('.miami-header'),
        $footer = $('.miami-footer');
    ...
    $(window).resize(function() {
        ...
        if (windowWidth <= 568) {
            ...
            $main.css({
                height: getHorizontalPageHeight() - 25,
                top: 0
            });
            $story_image.css({
                height: getHorizontalPageHeight() - 50,
                top: 0
            });
    ...
    var SitemapHeight = $(window).innerHeight();
    $("<style>.contact_us_layout{ height:calc( " + SitemapHeight + "px )!important; }</style>").appendTo("head");
